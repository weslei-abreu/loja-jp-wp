...
class Tbay_Widget_Single_Image extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'zota_single_image',
            esc_html__('Zota Single Image', 'zota'),
            array( 'description' => esc_html__( 'Show single image', 'zota' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'single_image' )); ?>"><?php esc_html_e( 'Image:', 'zota' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'alt' )); ?>"><?php esc_html_e( 'Alt:', 'zota' ); ?></label>
