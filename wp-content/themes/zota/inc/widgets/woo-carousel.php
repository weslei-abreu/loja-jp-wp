...
class Tbay_Widget_Woo_Carousel extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'zota_woo_carousel',
            esc_html__('Zota woocommerce Carousel', 'zota'),
            array( 'description' => esc_html__( 'Show list product', 'zota' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            ?>
            <label for="<?php echo esc_attr($this->get_field_id( 'categories' )); ?>"><?php esc_html_e( 'Please select category to show:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No woocommerce category found ', 'zota'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of products to show:', 'zota' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'types' )); ?>"><?php esc_html_e( 'Type Products:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose type product found ','zota'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns' )); ?>"><?php esc_html_e( 'Columns:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns product found ', 'zota'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_destsmall' )); ?>"><?php esc_html_e( 'Columns screen desktop small:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns desktop small product found ', 'zota'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_tablet' )); ?>"><?php esc_html_e( 'Columns screen tablet:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns table product found ','zota'); ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_mobile' )); ?>"><?php esc_html_e( 'Columns screen mobile:', 'zota' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'rows' )); ?>"><?php esc_html_e( 'Rows:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose rows product found ','zota'); ?>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('navigations')); ?>" name="<?php echo esc_attr($this->get_field_name('navigations')); ?>" type="checkbox" value="1" <?php checked( $navigations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('navigations') ); ?>">
                <?php esc_html_e('Show navigations','zota'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('paginations')); ?>" name="<?php echo esc_attr($this->get_field_name('paginations')); ?>" type="checkbox" value="1" <?php checked( $paginations ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('paginations') ); ?>">
                <?php esc_html_e('Show paginations','zota'); ?>
            </label>
        ...
        <p><input id="<?php echo esc_attr($this->get_field_id('disable_mobile')); ?>" name="<?php echo esc_attr($this->get_field_name('disable_mobile')); ?>" type="checkbox" value="1" <?php checked( $disable_mobile ); ?> />
            <label for="<?php echo esc_attr($this->get_field_id('disable_mobile') ); ?>">
                <?php esc_html_e('Disable mobile','zota'); ?>
            </label>
