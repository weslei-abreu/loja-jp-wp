...
class Tbay_Widget_Posts extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Zota Posts', 'zota'),
            // Widget description
            array( 'description' => esc_html__( 'Grid post widget', 'zota' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'ids' )); ?>"><?php esc_html_e( 'Posts:', 'zota' ); ?></label>
            <br>
