...
class Tbay_Widget_List_Categories extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Zota Woo List Categories', 'zota'),
            array( 'description' => esc_html__( 'Show list categories', 'zota' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'numbers' )); ?>"><?php esc_html_e( 'Number of categories to show:', 'zota' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'columns_desktop' )); ?>"><?php esc_html_e( 'Columns screen desktop:', 'zota' ); ?></label>
            ...
            <?php else: ?>
                ...
                <?php esc_html_e('No choose columns desktop product found ', 'zota'); ?>
