 ...
 * @since 1.0.0
 */
class Zota_Elementor_Button extends  Zota_Elementor_Widget_Base{
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return esc_html__( 'Zota Button', 'zota' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'link_button',
            [
                'label' => esc_html__( 'Link Button', 'zota' ),
        ...
        $this->add_control(
            'add_icon',
            [
                'label' => esc_html__( 'Add Icon', 'zota' ),
...
$widgets_manager->register(new Zota_Elementor_Button());
