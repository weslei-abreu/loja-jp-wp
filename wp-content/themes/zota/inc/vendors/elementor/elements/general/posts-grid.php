...
if ( ! defined( 'ABSPATH' ) || function_exists('Zota_Elementor_Posts_Grid') ) {
...
class Zota_Elementor_Posts_Grid extends Zota_Elementor_Carousel_Base {
    ...
    public function get_title() {
        return esc_html__( 'Zota Posts Grid', 'zota' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of posts', 'zota'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__( 'Number of posts to show ( -1 = all )', 'zota' ),
                'default' => 6,
                'max'  => 100,
                'min'  => 1
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'zota'),
                    'post_title' => esc_html__('Title', 'zota'),
    ...
    protected function register_title_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on' => esc_html__( 'Show', 'zota' ),
                'label_off' => esc_html__( 'Hide', 'zota' ),
                'default' => 'yes',
    ...
    protected function register_excerpt_controls() {
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label' => esc_html__( 'Excerpt Length', 'zota' ),
                'type' => Controls_Manager::NUMBER,
    ...
    protected function register_read_more_controls() {
        $this->add_control(
            'advanced_read_more',
            [
                'label' => esc_html__('Read More', 'zota'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'read_more_text',
            [
                'label' => esc_html__( 'Read More Text', 'zota' ),
    ...
    protected function register_meta_controls() {
        ...
        $this->add_control( 
            'show_comments',
            [
                'label' => esc_html__( 'Comments', 'zota' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'zota' ),
                'label_off' => esc_html__( 'Hide', 'zota' ),
                'default' => 'yes',
        ...
        $this->add_control( 
            'show_comments_text',
            [
                'label' => esc_html__( 'Comments Text', 'zota' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'zota' ),
                'label_off' => esc_html__( 'Hide', 'zota' ),
                'default' => 'no',
    ...
    public static function get_query_args($settings) {
        ...
        $query_args['posts_per_page'] = min(100, max(1, $settings['limit']));
    ...
    protected function register_design_image_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .entry-thumb img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
    ...
    private function get_template_post_type() {
        $folderes = glob(ZOTA_PAGE_TEMPLATES. '/posts/item-*');
...
$widgets_manager->register(new Zota_Elementor_Posts_Grid());