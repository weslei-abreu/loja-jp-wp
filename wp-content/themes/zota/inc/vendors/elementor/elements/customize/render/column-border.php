...
if ( !function_exists('zota_render_element_child_border')) {
    function zota_render_element_child_border( $widget ) {
    ...
    add_action('elementor/frontend/column/before_render', 'zota_render_element_child_border', 10, 2 );
}
