...
if ( !function_exists('zota_column_child_border')) {
    function zota_column_child_border( $widget ) {
        if( get_post_type() !== 'tbay_header'  ) return;

        $widget->start_controls_section(
            'element_child_border',
            array(
                'label' => esc_html__( 'Element border child', 'zota' ),
        ...
        $widget->add_control(
            ...
            array(
                'label'                 =>  esc_html__( 'Enable element border child', 'zota' ),
        ...
        $widget->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.enable-element-child-border-yes .elementor-element::after' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
    ...
    add_action( 'elementor/element/column/section_style/before_section_start', 'zota_column_child_border', 10, 1 );
}
