...
class Zota_Elementor_Compare extends Zota_Elementor_Widget_Base {
    public function get_name() {
        return 'tbay-compare';
    }

    public function get_title() {
        return esc_html__('Zota Compare', 'zota');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Compare', 'zota'),
                'condition' => [
...
$widgets_manager->register(new Zota_Elementor_Compare());
