...
class Zota_Elementor_Search_Canvas extends Zota_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Zota Search Canvas', 'zota');
    }
    ...
    protected function _register_form_canvas() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Search for products...','zota'),
            ]
        );
        $this->add_control(
            'vali_input_search',
    ...
    protected function register_style_search_canvas() {
        ...
        $this->add_control(
            'padding_search',
            [
                'label'     => esc_html__('Padding Icon Search', 'zota'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .btn-search-icon > i,
                    {{WRAPPER}} .btn-search-icon > svg'    => 'color: {{VALUE}}',
                ],
            ]
        );   
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    {{WRAPPER}} .btn-search-icon > svg:hover'    => 'color: {{VALUE}}',
                ],
            ]
        );   
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Hover', 'zota'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btn-search-icon > i:hover,
...
$widgets_manager->register(new Zota_Elementor_Search_Canvas());