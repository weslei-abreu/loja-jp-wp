...
if ( !class_exists("Zota_Tbay_mmenu_menu") ) {
    class Zota_Tbay_mmenu_menu extends Walker_Nav_Menu {
        ...
        public function generateSubMegaMenu( $item, $tbay_mega_profile ) {
            ...
            if ( $tbay_mega_profile ) {
                ...
                if ( $posts && isset($posts[0]) ) {
                    ...
                    if (defined('TBAY_ELEMENTOR_ACTIVED') && zota_elementor_is_activated() && in_array('tbay_megamenu', get_option('elementor_cpt_support'))) {
                    ...
                    if( zota_tbay_get_config('ajax_dropdown_megamenu', false) ) {  
