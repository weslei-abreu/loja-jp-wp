...
(function (factory) {
    ...
    var methods = {
        start: function (sec) {
            ...
            if (sec) {
                ...
                // save start time
                this.data('ttStartTime', jQuery.now());
    ...
    if (typeof jQuery.support.transition === 'undefined') {
        ...
        for (j = 0; j < arguments.length; j += 1) {
            ...
            if (j === 0 && typeof arg === 'string') {
                ...
                if (typeof arg.getTime === 'function') {
                    ...
                    options = jQuery.extend(options, arg);
                }
    ...
    function tick(digit) {
        ...
        if (digit === data.iSec) {
            ...
            timeDiff = jQuery.now() - data.ttStartTime;
