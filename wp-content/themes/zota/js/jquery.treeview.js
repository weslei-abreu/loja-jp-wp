	...
	jQuery.extend(jQuery.fn, {
		...
		treeview: function(settings) {
			...
			function treeController(tree, control) {
				...
				jQuery("a:eq(0)", control).on("click",  handler(CLASSES.collapsable) );
				// click on second to expand tree
				jQuery("a:eq(1)", control).on("click",  handler(CLASSES.expandable) );
				// click on third to toggle tree
				jQuery("a:eq(2)", control).on("click",  handler() ); 
			}
