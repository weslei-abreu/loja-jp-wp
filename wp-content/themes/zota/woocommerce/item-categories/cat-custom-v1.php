...
$cat_count      =   zota_get_product_count_of_category($tab['category']);
        ...
        <?php if ( (isset($shop_now) && $shop_now == 'yes') ) { ?>
            <div class="cat-hover">
                <?php if ( $count_item == 'yes' ) { ?>
                    <span class="count-item"><?php echo trim($cat_count).' '. apply_filters( 'zota_tbay_categories_count_item', esc_html__('items','zota') ); ?></span>
                <?php } ?>
