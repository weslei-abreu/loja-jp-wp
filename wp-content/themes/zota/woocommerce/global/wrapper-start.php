...
$configs 			= zota_class_wrapper_start();
...
?>
	...
	<div id="main-wrapper" class="<?php echo esc_attr( $configs['main'] ); ?>">
		<?php do_action( 'zota_woo_template_main_before' ); ?>
		...
		<div id="main-container" class="container">
			<div class="row <?php echo esc_attr($class_row); ?>">
				...
				<div id="main" class="<?php echo zota_wc_wrapper_class($configs['content']) ;?>"><!-- .content -->

				<?php $display_type = woocommerce_get_loop_display_mode();
					if('subcategories' === $display_type || 'both' === $display_type) { ?>
					<ul class="all-subcategories"><?php zota_woocommerce_sub_categories(); ?></ul>
				<?php } ?>