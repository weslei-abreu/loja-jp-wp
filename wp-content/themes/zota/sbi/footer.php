...
$zota_atts = json_decode($shortcode_atts, true);

if( !empty($zota_atts['tb-atts']) ) {
    $use_pagination = ( $zota_atts['data-layout'] === 'carousel' ) ? false : $use_pagination;
}
?>
<div id="sbi_load">
    ...
    <span class="sbi_follow_btn<?php echo esc_attr( $follow_btn_classes ); ?>">
        <a href="<?php echo esc_url( 'https://www.instagram.com/' . $first_username . '/' ); ?>" <?php echo trim($follow_btn_style); ?> target="_blank" rel="noopener nofollow"><?php echo SB_Instagram_Display_Elements::get_icon( 'instagram', $icon_type );echo esc_html( $follow_button_text ); ?></a>
    </span>
	<?php endif; ?>
