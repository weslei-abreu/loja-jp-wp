...
class Client {
    ...
    public function updater() {
        ...
        _deprecated_function( __CLASS__ . '::updater', '2.0', '\WeDevs\DokanPro\Dependencies\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

        // initialize the new updater
        if ( method_exists( '\WeDevs\DokanPro\Dependencies\Appsero\Updater', 'init' ) ) {
            \WeDevs\DokanPro\Dependencies\Appsero\Updater::init( $this );
        }
    }
