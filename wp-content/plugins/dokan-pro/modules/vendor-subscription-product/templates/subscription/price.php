    ...
    <div class="dokan-form-group subscription-price dokan-clearfix">
        <div
            ...
            data-product-id="<?php echo esc_attr( $post_id ); ?>">
                ( <?php esc_html_e( ' You Earn : ', 'dokan' ) ?>
                    <span class="vendor-price"><?php echo wp_kses_post( wc_price( dokan()->commission->get_earning_by_product( $post_id, 'seller', WC_Subscriptions_Product::get_price( $post_id ) ), [ 'decimals' => wc_get_price_decimals(), ] ) ); ?></span>
                )
        </div>
      </label>
