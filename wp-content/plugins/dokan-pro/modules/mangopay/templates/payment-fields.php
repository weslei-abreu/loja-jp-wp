<?php
/**
 * @var boolean $credit_card_activated
 * @var boolean $credit_card_enabled
 * @var boolean $debit_card_enabled
 * @var boolean $saved_cards_enabled
 * @var array $available_card_types
 * @var array $selected_credit_cards
 * @var array $available_direct_payments
 * @var array $selected_debit_cards
 * @var array $months
 * @var array $years
 * @var string $selected_card
 * @var string $mangopay_url
