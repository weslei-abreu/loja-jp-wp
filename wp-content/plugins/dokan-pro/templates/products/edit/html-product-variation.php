        ...
        <div class="data">
            ...
            <div class="variable_pricing show_if_variable show_if_variable-subscription">
                ...
                <div class="content-half-part hide_if_variable-subscription" style="padding-right: 16px;">
                    ...
                    <span class="vendor-earning">( <?php esc_html_e( ' You Earn : ', 'dokan' ); ?><span class="vendor-price"><?php echo wp_kses_post( wc_price( dokan()->commission->get_earning_by_product( $variation->ID ), [ 'decimals' => wc_get_price_decimals() ] ) ); ?></span> )</span>
