...
echo esc_html( sprintf( __( 'Hi %1$s, %2$s', 'dokan' ), $seller_name, " \n\n" ) );
// translators: 1: Refund Request Status, 2: Newline character.
echo esc_html( sprintf( __( 'Your refund request is %1$s. %2$s', 'dokan' ), $status, " \n\n" ) );
// translators: 1: Order ID, 2: Newline character.
echo esc_html( sprintf( __( 'Order ID : %1$s %2$s', 'dokan' ), $order_id, " \n" ) );
// translators: 1: Refund amount, 2: Newline character.
echo esc_html( sprintf( __( 'Refund Amount : %1$s %2$s', 'dokan' ), $amount, " \n" ) );
// translators: 1: Refund reason, 2: Newline character.
echo esc_html( sprintf( __( 'Refund Reason : %1$s %2$s', 'dokan' ), $reason, " \n\n" ) );
// translators: 1: Order page URL, 2: Newline character.
echo esc_html( sprintf( __( 'You can view the order details by visiting this link. %1$s %2$s', 'dokan' ), $order_link, " \n" ) );
