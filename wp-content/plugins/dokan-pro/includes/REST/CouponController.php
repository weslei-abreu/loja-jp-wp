...
class CouponController extends DokanRESTController {
    ...
    public function register_routes() {
        ...
        register_rest_route( $this->namespace, '/' . $this->base . '/marketplace', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
    ...
    private function get_marketplace_coupon_meta( $coupon_id ) {
        return [
            ...
            'vendor_ids'        => array_map( 'intval', explode( ',', get_post_meta( $coupon_id, 'coupons_vendors_ids', true ) ?: '' ) ),
            'exclude_vendor_ids' => array_map( 'intval', explode( ',', get_post_meta( $coupon_id, 'coupons_exclude_vendors_ids', true ) ?: '' ) ),
    ...
    public function get_marketplace_coupons( $request ) {
        try {
            ...
            if ( ! empty( $store_id ) ) {
                ...
                $seller_coupons = dokan_get_marketplace_seller_coupon( $store_id, $show_on_store );
