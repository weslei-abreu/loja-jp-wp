...
registerBlockType( 'tickera/event-add-to-cart-columns', {
    title: __( 'Event - Add To Cart Columns' ),
    description: __( 'Event add to cart table column names' ),
    icon: 'cart',
    category: 'widgets',
    keywords: [],
...
registerBlockType( 'tickera/event-add-to-cart-rows', {
    title: __( 'Event - Add To Cart Values' ),
    description: __( 'Event add to cart table values' ),
    icon: 'cart',
    category: 'widgets',
    keywords: [],
    supports: supports_args,
