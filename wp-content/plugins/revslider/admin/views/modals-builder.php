					...
					<div class="rbm_content_right">
						...
						<div id="action_inputs">
							...
							<div id="la_settings_layer_actions_frame" class="la_settings">
								<label_a></label_a><select id="la_gotoframeX"  data-evt="updatePlayFrameXOnlyOnAction" data-evtparam="X" data-r="actions.action.#actionindex#.gotoframe" class="callEvent easyinit actioninput nosearchbox tos2"></select>
								<span class="linebreak"></span>
							...
							<div id="la_settings_layer_actions_frameXY" class="la_settings">
								...
								<label_a><?php _e('Frame M', 'revslider');?></label_a"updatePlayFrameXOnlyOnAction" data-evtparam="M" data-r="actions.action.#actionindex#.gotoframeM" class="callEvent easyinit actioninput nosearchbox tos2"></select>
								<span class="linebreak"></span>
