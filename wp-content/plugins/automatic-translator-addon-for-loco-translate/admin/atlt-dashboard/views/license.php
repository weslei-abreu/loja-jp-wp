<div class="atlt-dashboard-license">
    ...
    <div class="header">
        <h1><?php _e('License Key', $text_domain); ?></h1>
        <div class="atlt-dashboard-status">
            <span><?php _e('Free', $text_domain); ?></span>
            <a href="https://locoaddon.com/pricing/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=license" class='atlt-dashboard-btn' target="_blank">
