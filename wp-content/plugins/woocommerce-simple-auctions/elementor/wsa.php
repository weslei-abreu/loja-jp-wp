...
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
	...
	final class Wsa_Extension {
		...
		public function __construct() {	
			...
			add_action( 'elementor/documents/register', [ $this, 'register_documents' ],20 );
		}
		...
		public function init_widgets() {
			...
			require_once( __DIR__ . '/widgets/auction_latest_bids.php' );
			require_once( __DIR__ . '/widgets/auction_pay.php' );
			...
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ElementorPro\Modules\Woocommerce\Widgets\Auction_Latest_Bids() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ElementorPro\Modules\Woocommerce\Widgets\Auctions() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \ElementorPro\Modules\Woocommerce\Widgets\Auction_Pay() );
