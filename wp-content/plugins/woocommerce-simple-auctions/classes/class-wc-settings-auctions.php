			...
			array(	'title' => esc_html__( 'Simple auction options', 'wc_simple_auctions' ), 'type' => 'title','desc' => '', 'id' => 'simple_auction_options' ),
										array(
											...
											'options'  => apply_filters( 'wsa_default_auction_orderby_options', array(
												...
												'rand' => esc_html__('Random sort auctions', 'wc_simple_auctions' ),
										...
										array(
											'title' 			=> esc_html__( "Allow relist of paid auctions.", 'wc_simple_auctions' ),
											'type' 				=> 'checkbox',
											'id'				=> 'simple_auctions_relist_paid',
											'default' 			=> 'no'
										),
