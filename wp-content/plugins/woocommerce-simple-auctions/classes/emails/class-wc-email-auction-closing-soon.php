    ...
    function init_form_fields() {
    	$this->form_fields = array(
			...
			'interval2' => array(
				...
				'custom_attributes' => array('step'	=> '0.5', 'min'	=> '0.5'),
				'description' 	=> sprintf( __( 'Send reminder mail intervals in hour default is <code>%s</code>. This means email notifications will be sent <code>%s</code> hour(s) prior auction end time. Leave empty to disable', 'woocommerce' ), 'disabled', $this->interval2 ),
