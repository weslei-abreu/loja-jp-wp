...
<li class="woof_query_save_item woof_query_save_item_<?php echo esc_attr($key) ?>">
    ...
    ?>
    <a class="woof_link_to_query_save"  href="<?php echo esc_url_raw($link) ?>" target="blank" ><?php echo esc_html($counter) ?>.&nbsp;<?php echo esc_html($title) ?></a>
    <!-- <p class="woof_tooltip"><span class="woof_tooltip_data"><?php echo wp_kses_post(wp_unslash($get)) ?></span>&nbsp;<span class="woof_icon_save_query"><img src="<?php echo esc_url($ext_link) ?>/img/info.svg" alt="" /></span></p> -->
