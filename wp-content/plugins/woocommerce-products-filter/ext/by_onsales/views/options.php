...
<li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
    ...
    <strong class="woof_fix1"><?php esc_html_e("On sale", 'woocommerce-products-filter'); ?>:</strong>
    ...
    <a href="#" data-key="<?php echo esc_attr($key) ?>" data-name="<?php esc_html_e("On sale", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php echo esc_attr($key) ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
