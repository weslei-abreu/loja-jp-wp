...
<li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
    ...
    <span class="icon-question help_tip" data-tip="<?php esc_html_e('Show On backorder checkbox inside woof search form', 'woocommerce-products-filter') ?>"></span>
    ...
    <a href="#" data-key="<?php echo esc_attr($key) ?>" data-name="<?php esc_html_e("Exclude on backorder", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php echo esc_attr($key) ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
