...
class WOOF_ACF_FILTER_TRUE_FALSE extends WOOF_ACF_FILTER_TYPE {

    public $type = 'true_false';
    protected $js_func_name = "woof_init_acf_true_false";
    ...
    public function wp_footer() {
        wp_enqueue_script('acf-true_false-js', $this->get_meta_filter_link() . 'js/true_false.js', array('jquery'), WOOF_VERSION, true);
    }
