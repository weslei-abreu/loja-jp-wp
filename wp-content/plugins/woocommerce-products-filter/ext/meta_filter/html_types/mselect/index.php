...
class WOOF_META_FILTER_MSELECT extends WOOF_META_FILTER_TYPE {
    ...
    public function woof_print_html_type_meta() {
        ...
        //$data['relation'] = (isset(woof()->settings[$this->meta_key]["search_logic"])) ? woof()->settings[$this->meta_key]["search_logic"] : 'OR';
        $data['relation'] = 'OR';
        $data['meta_options'] = (isset($this->type_options["options"])) ? $this->type_options["options"] : "";
        $data['meta_settings'] = (isset(woof()->settings[$this->meta_key])) ? woof()->settings[$this->meta_key] : "";
    ...
    public function create_meta_query() {
        ...
        if (!empty($meta)) {
            $meta['relation'] = (isset(woof()->settings[$this->meta_key]['search_logic'])) ? woof()->settings[$this->meta_key]['search_logic'] : 'OR';
            return $meta;
        }
