...
final class WOOF_EXT_URL_REQUEST extends WOOF_EXT {
    ...
    public function __construct() {
        ...
        if (empty(trim(get_option('permalink_structure')))) {
            return false;
        }
    ...
    public function init_js() {
        ...
        wp_localize_script('woof_url_parser', 'url_parser_data', apply_filters('woof_url_parser_all_data', $all_data));
    }
