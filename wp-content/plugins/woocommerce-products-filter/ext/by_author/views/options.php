    ...
    <div id="woof-modal-content-<?php echo esc_html($key) ?>" style="display: none;">
        ...
        <div class="woof-form-element-container">
            ...
            <div class="woof-name-description">
                ...
                <span><?php esc_html_e('Which users by the selected role to show', 'woocommerce-products-filter') ?></span>
            </div>
        ...
        <div class="woof-form-element-container">
            ...
            <div class="woof-name-description">
                ...
                <span><?php esc_html_e('How to display search by author filter section', 'woocommerce-products-filter') ?></span>
            </div>
