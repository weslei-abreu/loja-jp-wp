                    ...
                    <li>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="button" value="&#xea49" data-key="<?php echo esc_attr($term_key) ?>" data-name="<?php printf(esc_html_e('Image settings for term %s', 'woocommerce-products-filter'), esc_html($t['name'])) ?>" class="woof-button js_woof_options js_woof_options_image icon-book">
