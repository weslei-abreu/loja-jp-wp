    ...
    'sections' => [
        [
            ...
            'table' => [
                ...
                'rows' => [
                    'width' => [
                        ['value' => ['element' => 'ranger', 'value' => 25, 'min' => 10, 'max' => 500, 'conditions' => []], 'measure' => 'px'], //cell
                        ['value' => esc_html__('Min width', 'woocommerce-products-filter')] //cell
                    ],
                    'height' => [
                        ['value' => ['element' => 'ranger', 'value' => 25, 'min' => 10, 'max' => 500], 'measure' => 'px'], //cell
        ...
        [
            ...
            'table' => [
                ...
                'rows' => [
                    ...
                    'counter_width' => [
                        ['value' => ['element' => 'ranger', 'value' => 18, 'min' => 10, 'max' => 72, 'conditions' => [
                                    'hide' => [
