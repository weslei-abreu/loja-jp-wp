...
<input type="<?php echo esc_attr($type == 'tabs_radio' ? "radio" : "checkbox") ?>" <?php checked($checked) ?> name="woof_section_tabs" id="woof_tab_<?php echo esc_attr($key . "_" . $id); ?>">
        <label class="woof_section_tab_label" for="woof_tab_<?php echo esc_attr($key . "_" . $id) ?>" id="woof_<?php echo esc_attr($key . "_" . $id); ?>_content">
		<?php esc_html_e(WOOF_HELPER::wpml_translate(null, $title)) ?>
		<span>+</span>
		</label>
